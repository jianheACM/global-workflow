...
# initialize
module load gnu intel/2023.2.0 netcdf/4.7.0 
...
#JKHpostDir=${ROTDIR}/${CDUMP}.${yyyymmdd}/${hh}/products/${COMPONENT}/grib2/0p25/post
...
do
    ...
    wgrib2 ${postDir}/../grib2/0p25/${src_gribfile} -set_grib_type c3 -new_grid_winds grid \
...
${MKDIR} -p ${tgt_gribfile_dir}
cd ${tgt_gribfile_dir}
${ECHO} "Creating links for full domain...."
${LN} -fs ../../grib2/0p25/${src_gribfile}
