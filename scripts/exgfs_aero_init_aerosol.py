...
#tracer_list_file_pattern = "{parm_gfs}/chem/ccpp-chem_tracer.list"               # Text list of tracer names to copy
tracer_list_file_pattern = "{parm_gfs}/gocartracm_L65/ccpp-chem_tracer.list"   # Text list of tracer names to copy
